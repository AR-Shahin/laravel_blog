        ...
        <div class="container">
            ...
            <div id="navbarcollapse" class="collapse navbar-collapse">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item"><a href="{{route('home')}}" class="nav-link @if($main_menu  == 'Home') active @endif">Home</a>
                    </li>
                    <li class="nav-item"><a href="{{route('blog')}}" class="nav-link @if($main_menu  == 'Blog') active @endif">Blog</a>
                    </li>
                    <li class="nav-item"><a href="{{route('contact')}}" class="nav-link @if($main_menu  == 'Contact') active @endif">Contact</a>
                    </li>
                    @if(Auth::guard('user')->check())
                    <li class="nav-item"><a href="{{route('users.profile')}}" class="nav-link @if($main_menu  == 'Profile') active @endif">Profile</a>
                    </li>
                        @endif
